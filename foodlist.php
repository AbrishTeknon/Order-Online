...
<html>
  ...
  <head>
    <title> Explore | Food Sine's Cafe' </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Sine's Cafe'</a>
        </div>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <img src="images/piza.jpg" style="width:100%;">
...
<h5 class="text-danger">Birr <?php echo $row["price"]; ?>/-</h5>
